...
class AnagramChecker:
    def __init__(self, word_list_file="sowpods.txt"):
        ...
        # Create the full path to the word list file
        word_list_path = os.path.join(current_dir, word_list_file)
        
        with open(word_list_path, "r") as f:
            self.words = set(word.strip().lower() for word in f.readlines())
